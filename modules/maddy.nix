...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    systemd =
      let
        configFile = builtins.toFile "maddy.conf" ''
      ...
      in
      {
        services.maddy-fs = {
          serviceConfig = {
            ...
            ExecStart = "${pkgs.maddy}/bin/maddy -config /var/lib/maddy/maddy.conf";
          ...
          preStart = ''
            ...
            chmod 640 /var/lib/maddy/maddy.conf
            sed -i "s/#password#/$DB_PASS/g" /var/lib/maddy/maddy.conf
          '';
    ...
    networking.firewall = mkIf cfg.openFirewall {
      allowedTCPPorts = [ 25 143 587 465 993 ];
    };
