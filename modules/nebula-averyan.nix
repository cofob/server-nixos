...
in
{
  ...
  config = mkIf cfg.enable {
    age.secrets.nebula-averyan-ca.file = ../secrets/nebula-averyan/ca-crt.age;
    age.secrets.nebula-averyan-key.file = ../secrets/nebula-averyan + "/${config.networking.hostName}-key.age";
    age.secrets.nebula-averyan-crt.file = ../secrets/nebula-averyan + "/${config.networking.hostName}-crt.age";
